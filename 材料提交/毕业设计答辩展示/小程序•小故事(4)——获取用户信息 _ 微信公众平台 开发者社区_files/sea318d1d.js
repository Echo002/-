...
var t="developers.weixin.qq.com"==location.hostname?"https://res.wx.qq.com/":"/",n=function(e){
var t=e.lastIndexOf(".");
return t>=0?e.substring(t):"";
},s=e.data.pathinfo={
".js":"wxopenforumres/zh_CN/htmledition/js/",
".tpl":"wxopenforumres/zh_CN/htmledition/js/",
".html":"wxopenforumres/zh_CN/htmledition/js/",
".css":"wxopenforumres/htmledition/style/"
};
e.config({
base:t,
map:[function(t){
var r=n(t),o=e.data.base,i=t.substr(o.length);
if("undefined"!=typeof MODULES&&MODULES[i]){
var a=MODULES[i],f=a;
return 0==f.indexOf("http://")||0==f.indexOf("https://")?f:(-1==f.indexOf(o.replace("/c/=",""))&&(f=o+a),
".js"!=r&&".css"!=r&&(f=f.replace("/c/=","")),f);
}
return o.replace("/c/=","")+s[r]+i+"?20130807";
}]
});
}(seajs);;